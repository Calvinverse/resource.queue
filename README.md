...
provided by the [Azure events](https://github.com/Calvinverse/infrastructure.azure.core.events)
repository. Those scripts will create a RabbitMQ cluster of the suitable size.
