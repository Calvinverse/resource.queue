...
# erlang cookie
consul_template_erlang_cookie = node['erlang']['consul_template_erlang_cookie']
file "#{consul_template_template_path}/#{consul_template_erlang_cookie}" do
  action :create
  content <<~CONF
...
file "#{consul_template_config_path}/erlang_cookie.hcl" do
  ...
  content <<~HCL
    ...
    template {
      ...
      # the `contents` option.
      source = "#{consul_template_template_path}/#{consul_template_erlang_cookie}"

      # This is the destination path on disk where the source template will render.
      # If the parent directories do not exist, Consul Template will attempt to
      # create them, unless create_dest_dirs is false.
      destination = "#{erlang_cookie_file}"
